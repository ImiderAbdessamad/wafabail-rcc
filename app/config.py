...
DIRECT_FINANCIAL_RENDER_DPI = int(os.getenv("DIRECT_FINANCIAL_RENDER_DPI", "240"))
...
DIRECT_FINANCIAL_MAX_IMAGE_DIMENSION = int(
    os.getenv("DIRECT_FINANCIAL_MAX_IMAGE_DIMENSION", "2600")
)
...
# --- Pipeline hybride local : audit -> orientation -> routage -> preuves -------
# Les adaptateurs RapidOCR / Docling sont optionnels. Une d̩pendance absente
# d̩grade proprement vers le pipeline GLM existant au lieu de bloquer le job.
HYBRID_FINANCIAL_PIPELINE = os.getenv(
...
DOCLING_SCAN_ENABLED = os.getenv("DOCLING_SCAN_ENABLED", "true").lower() in {
    "1",
    "true",
    "yes",
}
NATIVE_TEXT_MIN_CHARS = int(os.getenv("NATIVE_TEXT_MIN_CHARS", "80"))
ORIENTATION_OCR_MAX_SIDE = int(os.getenv("ORIENTATION_OCR_MAX_SIDE", "1400"))
LOCAL_OCR_TEXT_MAX_SIDE = int(os.getenv("LOCAL_OCR_TEXT_MAX_SIDE", "2200"))
CLASSIFICATION_MAX_IMAGE_DIMENSION = int(
    os.getenv("CLASSIFICATION_MAX_IMAGE_DIMENSION", "1200")
)
DOCLING_MAX_PAGES = int(os.getenv("DOCLING_MAX_PAGES", "20"))
